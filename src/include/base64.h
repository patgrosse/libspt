/*
 * Based on RIOT OS https://github.com/RIOT-OS/RIOT/blob/master/sys/include/base64.h
 */
/*
 ...
 */
int8_t base64_decode(unsigned char *base64_in, size_t base64_in_size, \
                  unsigned char *data_out, size_t *data_out_size);

/**
 * Get the maximum amount of characters required if the given amount bytes is represented in base64
 * @param data_in_size The amount of bytes in binary
 * @return The maximum amount of bytes required in base64
 */
size_t base64_required_size_in_base64(size_t data_in_size);

/**
 * Get the maximum amount of bytes required if the given amount base64 characters is represented in binary
 * @param base64_in_size The amount of characters in base64
 * @return The maximum amount of bytes required in binary
 */
size_t base64_required_size_from_base64(size_t base64_in_size);
